	...
	<c:if test="${ not empty list }">
	 <c:forEach items="${ list }" var="dto">
		 <tr class="data">
		   ...
		   <td>
		     <c:if test="${ dto.depth gt 0 }"><!-- 답글인 경우  -->
		       <img width="${ dto.depth*10 }px"/><!-- 없는 이미지 태그 == 공백 == 들여쓰기 -->
		     ...
		     <c:if test="${ dto.newImg }">
		       <img src="/JspPro/days16/replyboard/images/ico-new.gif" alt="new" />
		     </c:if>
		   </td>
		   <td>
		     <c:if test="${ dto.writer eq 'kenik' }">
		       <img src="/JspPro/days16/replyboard/images/star.gif" alt="star" />
		     </c:if>
